...
export default function Header() {
  return (
    <header className="relative bg-cream-light">
      <div className="mx-auto flex max-w-content items-center justify-between gap-2 px-3 py-2 sm:gap-4 sm:px-6 sm:py-3 lg:px-10">
        <motion.div
